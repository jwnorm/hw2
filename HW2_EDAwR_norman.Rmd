...
>The relationships chosen above seem to be the same for both the UP and LP. There is a negative relationship between unemployment and povertyas well as between self-employment and income. There is a positive relationship between unemployment and poverty. All of these hold true for both peninsulas. The faceting shows that the two peninsulas are similar in these three regards.
