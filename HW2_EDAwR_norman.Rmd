...
```{r histo_density}
ggplot(county_df, aes(Income)) + geom_histogram(binwidth = 5000, 
                                                fill = "steelblue", color = "black") + geom_density(aes(y = 5000 * ..count..)) + labs(title = "Distribution of Income for US Counties", y = "Number of Counties")
...
ggplot(county_df[county_df$TotalPop<2500000,], aes(TotalPop)) + 
  geom_histogram(fill = "steelblue", color = "black") + labs(title = "Distribution of Population for US Counties", x = "Total Population", y = "Number of Counties")
```
